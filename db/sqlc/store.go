...
type Store struct {
	*Queries // composition: all individual query functions provided by Queries will be available to Store
	db       *sql.DB
}
...
// TransferTxParams contains the input paramerters of the transfer transaction
